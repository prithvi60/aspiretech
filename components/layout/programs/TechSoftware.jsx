...
const TechSoftware = ({ data, data2 }) => {
    return (
        <div className="padding max-w-7xl mx-auto w-full font-inter text-foreground">
            <div className='rounded-3xl px-7 md:px-14 py-8 md:py-20 border-6 border-borderColor bg-white box-shadow-gradient space-y-5'>
                <div className="w-full space-y-3 lg:space-y-5">
                    <h1 className="text-[clamp(1.5rem,3.5vw,2.5rem)] leading-6 md:leading-10 tracking-wide font-bold w-full text-center">
