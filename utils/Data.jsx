...
export const followingActivities = [
    ...
    "Posting content that infringes upon intellectual property rights or other proprietary rights, violates laws or contractual relationships, contains malicious software, or poses privacy or security risks.", "Engaging in unsolicited or unauthorised advertising, promotional materials, commercial activities, 'spam', or any other form of solicitation.", "Posting unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, pornographic, libellous, invasive, hateful, or otherwise objectionable content.", " Interfering with or disrupting the Service, its servers, or connected networks, or disobeying network-related requirements, procedures, policies, or regulations.", "Violating any applicable local, state, national, or international laws or regulations or impersonating any person or entity.", "Harvesting or collecting user email addresses or contact information for unsolicited communications.", "Advertising, selling, or buying goods or services for unauthorised business purposes.", "Attempting to access materials or information not intentionally provided through the Service."
]

export const certificationsReq = [
    "The successful completion of graded assignments with a minimum passing score/grade.", "The satisfactory completion of a project and viva as determined by the Subject Matter   Expert (SME) or Mentor.", "Meeting the minimum attendance requirements specified for the program.", "If all criteria are met, Aspire Tech Academy or the University will commence the certification process.", "Graded assignments, distinct from practice or non-graded assignments, are clearly outlined in the Learning Management System (LMS). Additionally, Aspire Tech Academy includes one end-of-course certification exam in the course fee.", "Some courses do not allow multiple attempts for certification exams, and in cases where a student requires a repeat exam, an additional fee may apply."
]

export const referAFriend = [
    "Referrers must submit leads online or contact a counsellor, providing at least the lead's name and telephone number.", "Referral bonuses, up to 5 to 10% of the course selling price net of discounts, apply to the first program enrolled by the new referee.", "Selling price calculations exclude GST and discounts/scholarships.", "Friends must enrol within 45 calendar days from the date of referral to qualify.", "In cases where multiple referrers submit the same lead, the referral fee is awarded to the first referrer based on the CRM entry date.", "Existing students are not eligible for referrals.", "Referral amounts can be claimed once the friend has purchased the course and met payment norms.", "Referral rewards are provided as Amazon vouchers and cannot be used for instalment payments, discounts, or other courses or a reduction in the fees", "Referral vouchers are non-transferable and cannot be converted into cash or other forms of credit.", "The referral program is one-way; friends referred cannot subsequently refer to the referrer.", "In case of disputes, management retains the final decision-making authority.", "Applicable TDS and taxes will be deducted from referral rewards.", "Referrals do not apply to blood relations, spouses, siblings, or cousins unless the referrer is an existing student."
]

export const refundPolicy = [
    "Unless explicitly agreed in writing by Aspire Tech Academy, full payment for program participation is due at registration. For programs offering a trial period, access to the trial is provided after full payment. During the trial, a refund of program fees, subject to applicable charges, may be considered upon request and approval by Aspire Tech Academy. After the trial period, no refunds will be granted for any reason.", "It is the responsibility of the user enrolling in a program to verify the program's accuracy, suitability, and relevance. Enrolment in a program is non-transferable.", "To make payments for programs or purchases through Aspire Tech Academy, users must have internet access and a valid accepted payment method. Aspire Tech Academy does not store credit card information and uses third-party payment providers. Users agree to the terms of these providers and are responsible for any losses incurred due to their use. Failure to pay may result in program access withdrawal.", "Depending on the transaction location and payment method, foreign exchange fees or rates may apply. Aspire Tech Academy does not support all payment methods, currencies, or locations. Taxes are based on billing information provided during enrollment or purchase.", "Enrolment may be cancelled at any time, but no refunds will be issued once payment (in part or full) has been made. Refunds are not provided for lack of usage or dissatisfaction.", "If a free trial is subscribed, it will be valid for the specified period. Free trials cannot be combined with certain offers, and eligibility depends on previous subscriptions and associated email addresses."
]