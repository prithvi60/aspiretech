    ...
    return (
        <section className="w-full h-full padding space-y-10 md:space-y-20 relative">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-4 h-full">
                ...
                <div className="w-full md:3/5 lg:w-4/5 space-y-5">
                    {filteredContent[0].phase && (
                        <p className="font-bold flex gap-2 text-foreground text-[clamp(1rem,1.5vw,1.25rem)] w-4/5">
                            {filteredContent[0].phase}
                        </p>
                    )}
