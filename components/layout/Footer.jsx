...
const Footer = () => {
    return (
        <footer
            className={`relative overflow-hidden w-full text-footerText font-inter bg-secondary text-foreground border-t-4 border-t-footerBorder`}
        >
            <div className="space-y-6 md:space-y-10 padding">
                ...
                <div className="flex flex-col md:justify-center md:items-center lg:items-start lg:flex-row lg:justify-between gap-6 lg:gap-8 w-full relative z-10">
                    <div className="flex flex-col gap-y-6 w-full md:w-2/5">
                        ...
                        <p className="text-lg md:text-xl tracking-wide font-bold text-foreground w-11/12">
                        ...
                        <div className="flex gap-5 md:gap-6">
                            <p className="text-sm font-semibold md:text-lg text-footerText">
                                Contact:
                            </p>
                        ...
                        <div className="flex gap-5 md:gap-6">
                            ...
                            <div className="text-sm font-semibold md:text-lg text-footerText">
                                <p className="w-full md:w-4/5">
                                    504, Tribe Co-working Space, 1st floor, Sector 3, HSR Layout,
                ...
                <p className="text-sm font-semibold md:text-lg text-footerText text-center">
                    {`Copyright © ${new Date().getFullYear()} All rights reserved with `}
                    <span className="font-extrabold tracking-wider">Aspire Tech Academy</span>
                    {` | All logos and Trademarks registered with their respective owners.`}
                </p>
            </div>
        </footer>
    );
